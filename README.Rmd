...
acquaint implements a [Model Context Protocol](https://modelcontextprotocol.io/) (MCP) for your R sessions. When configured with acquaint, MCP-enabled tools like Claude Desktop and Claude Code can run R code _in the sessions you have running_ to answer your questions. While the package supports configuring arbitrary R functions, acquaint provides a default set of tools [from btw](https://posit-dev.github.io/btw/) to:
