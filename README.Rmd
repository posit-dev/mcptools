...
acquaint implements a [Model Context Protocol](https://modelcontextprotocol.io/) (MCP) for your R session. When configured with acquaint, tools like Claude Desktop and Claude Code can:
